...
contract PancakeLocker is Ownable, ReentrancyGuard {
    ...
    function lockLPToken(
        ...
        address factoryPairAddress = pancakeFactory.getPair(
            lpair.token0(),
            lpair.token1()
        );
    ...
    function withdraw(
        ...
        if (userLock.amount == 0) {
            uint256[] storage userLocks = users[msg.sender]
                .locksForToken[_lpToken];
    ...
    /**
     * @notice migrates liquidity to pancake
     */
    function migrate(
        address _lpToken,
        uint256 _index,
