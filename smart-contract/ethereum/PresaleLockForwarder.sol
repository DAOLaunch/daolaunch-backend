...
/**
    This contract creates the lock on behalf of each presale. This contract will be whitelisted to bypass the flat rate ETH fee. Please do not use the below locking code in your own contracts as the lock will fail without the ETH fee
*/
...
contract PresaleLockForwarder is Ownable {
    ...
    constructor() public {
        PRESALE_FACTORY = IPresaleFactory(
            0x6B45a36255F6685405f6cadbEE8F591E49daF44a
        );
        UNICRYPT_LOCKER = IUniswapV2Locker(
            0x5A77f9FBBdCaDCA941D96e2364f0f16B4CF6e5CC
        );
